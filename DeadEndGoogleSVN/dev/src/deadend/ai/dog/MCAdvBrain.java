 ...
 * @author Yang JiaJian
 */
public class MCAdvBrain extends TeamBrainFound{

    public MCAdvBrain(DeadEndGame game,int timeLimit) {
        this.game=game;
        ...
        do{
            ...
            if(msim.simResult!=deadend.globalenum.GameResults.NotEnd){
                for(int i=0;i<this.game.dogs.dogTeam.size();i++){
                            ...
                            this.dcredits.get(i).autoAddCredit(d, msim.simResult);
                        }
                /*
