/*
 * universalUtil.neuralnetwork.wekaANNLayer
 * Copyright (C) Yang JiaJian 2009 <yangjeep@gmail.com>
 * universalUtil.neuralnetwork.wekaANNLayer is free software: you can redistribute it and/or modify it
 * under the terms of the GNU General Public License as published by the
 * Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 * 
 * universalUtil.neuralnetwork.wekaANNLayer is distributed in the hope that it will be useful, but
...
/**
 * The class wekaANNLayer implements the universal layer functions used in
...
public class wekaANNLayer {
    ...
    wekaANNLayer ParentLayer;
    wekaANNLayer ChildLayer;
